...
for n in range(len(all_image_paths)):
    ...
    all_final_images.append(img_array)

with open('Documents/Plantr/data_arrays/my_image_dataset_color', 'wb') as output:
    pickle.dump(all_final_images, output)

with open('Documents/Plantr/data_arrays/my_label_dataset_color', 'wb') as output:
